...
culture_keys=[99,51,52,144,114,140,149,146,150,152,153,163,164,116,70]
...
for culture_num in culture_keys:
    ...
    year_choices=np.arange(2000,2021,1)
    ...
    for year_choice in year_choices:
        ...
        db_region_test = client['region_test']

        collection_rt_france = db_region_test['france']
        ...
        portions=np.arange(portions_min,portions_max,0.02)
        ...
        new_document = {
            ...
            "annee": year_choice,
            "score70": score70, # You might want to fill this value
            'score80': score80,
            'mean_rms':mean_rms,
            'std_rms':std_rms,
            'max_rms':max_rms,
        ...
        collection_rt_france.insert_one(new_document)
